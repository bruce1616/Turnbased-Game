...
public class GameServer {
	...
	public GameServer() {
		...
		System.out.println("-> Who ever with a highest points will");
		System.out.println("be the winner of the game!");
		System.out.println("-> Each Player will click a button with");
		System.out.println("a random points each box.\n");
		numPlayers = 0;
		turnsMade = 0;
		maxTurns = 4;
		values = new int[4];
